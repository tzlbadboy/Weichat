		...
		<form action="RegisterServlet" method="post">
			<div class="bgfff form ov">
				...
				<ul class="cb">
					<li>
						<div class="fl la_bg tc">
							<label for="name" class="lable">您的姓名</label>
						</div>
						<div class="fl l_r">
					...
					<li>
						<div class="fl la_bg tc">
							<label for="name" class="lable">病历号</label>
						</div>
						<div class="fl l_r">
							<input name="cardId" type="text" id="name" required
								class="w_img95 i_bor">
						</div>
					</li>
					...
					<li>
						<div class="fl la_bg tc">
							<label for="name" class="lable">手机号码</label>
						</div>
						<div class="fl l_r">
							<input name="phone" type="text" id="name" required
								class="w_img95 i_bor">
						</div>
					</li>
					<!--  
               ...
               -->
				...
				<div class="cb pt20">
					<input type="submit" id="tijiao" value="提交信息" class="but">
				</div>
			</div>
		</form>
		<!-- 
